...
import Enumeraciones.CarTypes;
import Enumeraciones.FuelTypes;
...
public class Automoviles {
    ...
    public Automoviles(String Brand, int model, double engine, FuelTypes gasoline, CarTypes car, int doors, int seats, double maximumSpeed, String color, double currentSpeed) {
        this.Brand = Brand;
        this.model = model;
        this.engine = engine;
    ...
    public CarTypes getCar() {
        return car;
    }

    public void setCar(CarTypes car) {
        this.car = car;
    }
